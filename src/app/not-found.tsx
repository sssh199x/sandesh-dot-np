export default function NotFound() {
  return (
    <div className="flex min-h-svh flex-col items-center justify-center bg-dusk-contact px-6 text-center">
      ...
      <a
        href="/"
        className="mt-8 rounded-pill bg-copper-btn px-7 py-3 font-mono text-sm font-medium tracking-wide text-cream transition-colors duration-200 hover:bg-copper-dark"
      >
        Back to Home
      </a>
    </div>
